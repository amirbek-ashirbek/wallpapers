package com.example.wallpapers.feature_wallpapers.wallpapers.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import com.example.wallpapers.feature_wallpapers.wallpapers.data.local.dao.WallpaperCategoryDao
import com.example.wallpapers.feature_wallpapers.wallpapers.data.local.dao.WallpaperCategoryRemoteKeysDao
import com.example.wallpapers.feature_wallpapers.wallpapers.data.local.dao.WallpaperDao
import com.example.wallpapers.feature_wallpapers.wallpapers.data.local.dao.WallpaperRemoteKeysDao
